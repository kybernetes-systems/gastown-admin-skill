...
The 3-Minute Purge Standard, Rodriguez Compliance, and other named
policy targets belong in the Beads layer, populated by the Mayor agent
and Polecats during operation, not declared in HCL.
